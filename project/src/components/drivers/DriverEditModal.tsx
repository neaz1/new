...
export function DriverEditModal({ driver, onClose, onSave }: DriverEditModalProps) {
  const [formData, setFormData] = useState({
    ...
    cashierId: driver.cashierId || '', // Add cashier ID field
  });
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-xl">
        <div className="p-6">
          <div className="flex justify-between items-start">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white">دەستکاری زانیاری شۆفێر</h2>
            <button 
              onClick={onClose}
